...
var ShadowSidebar = function (_a) {
    ...
    return (<>
      ...
      <div className={classNames(styles.shadowSidebarContainer, "hidden sm:h-screen sm:flex sm:w-fit sm:inset-y-0")}>
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              <li>
                <ul role="list" className="-mx-2 space-y-1">
                  {sidebarOptions.map(function (option) { return (<li key={option.name}>
